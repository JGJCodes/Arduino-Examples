...
//------------------------------------ //Funcion ciclicla //------------------------------------ void loop() // Esta funcion se mantiene ejecutando 
{ 
  // cuando este energizado el Arduino //Guardar en una variable el valor de la lectura análoga 
